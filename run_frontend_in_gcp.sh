...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="retrivel-project-337416"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="guy_yutal" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute scp /home/guy_yutal/search_frontend.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
...
gcloud compute instances delete -q $Iinstance-1  
